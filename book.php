...
//	}
	...
	if(empty($errors))
	{
		...
		include ("username_session.php");
       		
		$sql = "INSERT INTO $tablename (username,name_user,name, phone, item, start_day, start_time, end_day, end_time, canceled)
			VALUES ('{$_SESSION['user']}','{$_SESSION['user_name']}','$name','$phone', '$item', $start_day, $start_time, $end_day, $end_time, 0)";
